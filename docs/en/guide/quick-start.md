...
- Neko Nya trackers and the straps
- Charging dock and receiver
- Receiver antenna
- A computer that can run SlimeVR

::: warning Before first use
Make sure the trackers are sufficiently charged, and read [Charging & Safety](/en/guide/charging-controls) first.
:::
...
3. Keep the receiver away from large metal surfaces and leave the area around the antenna clear.

**Done when:** the computer recognizes a USB device, and SlimeVR shows the receiver or tracker status after startup.

## 2. Power On the Trackers

### Batch power-on

Place the trackers into the charging dock and press the left button on the dock to power them all on.
